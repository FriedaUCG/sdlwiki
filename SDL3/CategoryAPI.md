...
- [SDL_SetGPURenderStateSamplerBindings](SDL_SetGPURenderStateSamplerBindings)
- [SDL_SetGPURenderStateStorageBuffers](SDL_SetGPURenderStateStorageBuffers)
- [SDL_SetGPURenderStateStorageTextures](SDL_SetGPURenderStateStorageTextures)
...
- [SDL_HINT_ANDROID_ALLOW_PERSISTENT_FOLDER_ACCESS](SDL_HINT_ANDROID_ALLOW_PERSISTENT_FOLDER_ACCESS)
...
- [SDL_HINT_AUDIO_DUCK_OTHERS](SDL_HINT_AUDIO_DUCK_OTHERS)
...
- [SDL_HINT_ENABLE_STEAM_SCREEN_KEYBOARD](SDL_HINT_ENABLE_STEAM_SCREEN_KEYBOARD)
...
- [SDL_HINT_WINDOWS_RAW_MOUSE_NOLEGACY](SDL_HINT_WINDOWS_RAW_MOUSE_NOLEGACY)
...
- [SDL_PEN_INPUT_IN_PROXIMITY](SDL_PEN_INPUT_IN_PROXIMITY)
...
- [SDL_PROP_GLOBAL_VIDEO_WAYLAND_SESSION_ID_STRING](SDL_PROP_GLOBAL_VIDEO_WAYLAND_SESSION_ID_STRING)
...
- [SDL_PROP_GPU_DEVICE_CREATE_XR_APPLICATION_NAME_STRING](SDL_PROP_GPU_DEVICE_CREATE_XR_APPLICATION_NAME_STRING)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_APPLICATION_VERSION_NUMBER](SDL_PROP_GPU_DEVICE_CREATE_XR_APPLICATION_VERSION_NUMBER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_ENABLE_BOOLEAN](SDL_PROP_GPU_DEVICE_CREATE_XR_ENABLE_BOOLEAN)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_ENGINE_NAME_STRING](SDL_PROP_GPU_DEVICE_CREATE_XR_ENGINE_NAME_STRING)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_ENGINE_VERSION_NUMBER](SDL_PROP_GPU_DEVICE_CREATE_XR_ENGINE_VERSION_NUMBER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_EXTENSION_COUNT_NUMBER](SDL_PROP_GPU_DEVICE_CREATE_XR_EXTENSION_COUNT_NUMBER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_EXTENSION_NAMES_POINTER](SDL_PROP_GPU_DEVICE_CREATE_XR_EXTENSION_NAMES_POINTER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_FORM_FACTOR_NUMBER](SDL_PROP_GPU_DEVICE_CREATE_XR_FORM_FACTOR_NUMBER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_INSTANCE_POINTER](SDL_PROP_GPU_DEVICE_CREATE_XR_INSTANCE_POINTER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_LAYER_COUNT_NUMBER](SDL_PROP_GPU_DEVICE_CREATE_XR_LAYER_COUNT_NUMBER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_LAYER_NAMES_POINTER](SDL_PROP_GPU_DEVICE_CREATE_XR_LAYER_NAMES_POINTER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_SYSTEM_ID_POINTER](SDL_PROP_GPU_DEVICE_CREATE_XR_SYSTEM_ID_POINTER)
- [SDL_PROP_GPU_DEVICE_CREATE_XR_VERSION_NUMBER](SDL_PROP_GPU_DEVICE_CREATE_XR_VERSION_NUMBER)
...
- [SDL_PROP_SURFACE_ROTATION_FLOAT](SDL_PROP_SURFACE_ROTATION_FLOAT)
...
- [SDL_PROP_TEXTINPUT_TITLE_STRING](SDL_PROP_TEXTINPUT_TITLE_STRING)
...
- [SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_POINTER](SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_POINTER)
- [SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_U_POINTER](SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_U_POINTER)
- [SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_UV_POINTER](SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_UV_POINTER)
- [SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_V_POINTER](SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_V_POINTER)
...
- [SDL_PROP_WINDOW_CURVATURE_FLOAT](SDL_PROP_WINDOW_CURVATURE_FLOAT)
...
- [SDL_PROP_WINDOW_QNX_SURFACE_POINTER](SDL_PROP_WINDOW_QNX_SURFACE_POINTER)
- [SDL_PROP_WINDOW_QNX_WINDOW_POINTER](SDL_PROP_WINDOW_QNX_WINDOW_POINTER)
...
- [SDL_SVE2_INTRINSICS](SDL_SVE2_INTRINSICS)
