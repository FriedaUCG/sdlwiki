...
- [SDL_EVENT_GAMEPAD_CAPSENSE_RELEASE](SDL_EVENT_GAMEPAD_CAPSENSE_RELEASE)
- [SDL_EVENT_GAMEPAD_CAPSENSE_TOUCH](SDL_EVENT_GAMEPAD_CAPSENSE_TOUCH)
...
- [SDL_EVENT_WINDOW_CURVATURE_CHANGED](SDL_EVENT_WINDOW_CURVATURE_CHANGED)
...
- [SDL_EVENT_WINDOW_SETTINGS_CHANGED](SDL_EVENT_WINDOW_SETTINGS_CHANGED)
...
- [SDL_FORMFACTOR_CAR](SDL_FORMFACTOR_CAR)
- [SDL_FORMFACTOR_CONSOLE](SDL_FORMFACTOR_CONSOLE)
- [SDL_FORMFACTOR_DESKTOP](SDL_FORMFACTOR_DESKTOP)
- [SDL_FORMFACTOR_HANDHELD](SDL_FORMFACTOR_HANDHELD)
- [SDL_FORMFACTOR_HEADSET](SDL_FORMFACTOR_HEADSET)
- [SDL_FORMFACTOR_LAPTOP](SDL_FORMFACTOR_LAPTOP)
- [SDL_FORMFACTOR_PHONE](SDL_FORMFACTOR_PHONE)
- [SDL_FORMFACTOR_TABLET](SDL_FORMFACTOR_TABLET)
- [SDL_FORMFACTOR_TV](SDL_FORMFACTOR_TV)
- [SDL_FORMFACTOR_UNKNOWN](SDL_FORMFACTOR_UNKNOWN)
- [SDL_FORMFACTOR_WATCH](SDL_FORMFACTOR_WATCH)
...
- [SDL_GAMEPAD_CAPSENSE_COUNT](SDL_GAMEPAD_CAPSENSE_COUNT)
- [SDL_GAMEPAD_CAPSENSE_INVALID](SDL_GAMEPAD_CAPSENSE_INVALID)
- [SDL_GAMEPAD_CAPSENSE_LEFT_GRIP](SDL_GAMEPAD_CAPSENSE_LEFT_GRIP)
- [SDL_GAMEPAD_CAPSENSE_LEFT_STICK](SDL_GAMEPAD_CAPSENSE_LEFT_STICK)
- [SDL_GAMEPAD_CAPSENSE_RIGHT_GRIP](SDL_GAMEPAD_CAPSENSE_RIGHT_GRIP)
- [SDL_GAMEPAD_CAPSENSE_RIGHT_STICK](SDL_GAMEPAD_CAPSENSE_RIGHT_STICK)
...
- [SDL_GAMEPAD_TYPE_STEAM](SDL_GAMEPAD_TYPE_STEAM)
...
- [SDL_GPU_SHADERSAMPLERTYPE_COMPARISON](SDL_GPU_SHADERSAMPLERTYPE_COMPARISON)
- [SDL_GPU_SHADERSAMPLERTYPE_FILTERING](SDL_GPU_SHADERSAMPLERTYPE_FILTERING)
- [SDL_GPU_SHADERSAMPLERTYPE_NONE](SDL_GPU_SHADERSAMPLERTYPE_NONE)
- [SDL_GPU_SHADERSAMPLERTYPE_NONFILTERING](SDL_GPU_SHADERSAMPLERTYPE_NONFILTERING)
- [SDL_GPU_SHADERSTAGE_FRAGMENT](SDL_GPU_SHADERSTAGE_FRAGMENT)
- [SDL_GPU_SHADERSTAGE_VERTEX](SDL_GPU_SHADERSTAGE_VERTEX)
- [SDL_GPU_SHADERTEXTURESAMPLETYPE_DEPTH](SDL_GPU_SHADERTEXTURESAMPLETYPE_DEPTH)
- [SDL_GPU_SHADERTEXTURESAMPLETYPE_FILTERABLE_FLOAT](SDL_GPU_SHADERTEXTURESAMPLETYPE_FILTERABLE_FLOAT)
- [SDL_GPU_SHADERTEXTURESAMPLETYPE_MULTISAMPLED_DEPTH](SDL_GPU_SHADERTEXTURESAMPLETYPE_MULTISAMPLED_DEPTH)
- [SDL_GPU_SHADERTEXTURESAMPLETYPE_MULTISAMPLED_UNFILTERABLE_FLOAT](SDL_GPU_SHADERTEXTURESAMPLETYPE_MULTISAMPLED_UNFILTERABLE_FLOAT)
- [SDL_GPU_SHADERTEXTURESAMPLETYPE_SINT](SDL_GPU_SHADERTEXTURESAMPLETYPE_SINT)
- [SDL_GPU_SHADERTEXTURESAMPLETYPE_UINT](SDL_GPU_SHADERTEXTURESAMPLETYPE_UINT)
- [SDL_GPU_SHADERTEXTURESAMPLETYPE_UNFILTERABLE_FLOAT](SDL_GPU_SHADERTEXTURESAMPLETYPE_UNFILTERABLE_FLOAT)
...
- [SDL_GPU_STORAGETEXTUREACCESS_READ_ONLY](SDL_GPU_STORAGETEXTUREACCESS_READ_ONLY)
- [SDL_GPU_STORAGETEXTUREACCESS_READ_WRITE](SDL_GPU_STORAGETEXTUREACCESS_READ_WRITE)
- [SDL_GPU_STORAGETEXTUREACCESS_WRITE_ONLY](SDL_GPU_STORAGETEXTUREACCESS_WRITE_ONLY)
...
- [SDL_PIXELFORMAT_P408](SDL_PIXELFORMAT_P408)
- [SDL_PIXELFORMAT_P416](SDL_PIXELFORMAT_P416)
...
- [SDL_SANDBOX_LOMIRI](SDL_SANDBOX_LOMIRI)
...
- [SDL_SYSTEM_CURSOR_ALIAS](SDL_SYSTEM_CURSOR_ALIAS)
- [SDL_SYSTEM_CURSOR_ALL_SCROLL](SDL_SYSTEM_CURSOR_ALL_SCROLL)
- [SDL_SYSTEM_CURSOR_CELL](SDL_SYSTEM_CURSOR_CELL)
- [SDL_SYSTEM_CURSOR_COL_RESIZE](SDL_SYSTEM_CURSOR_COL_RESIZE)
- [SDL_SYSTEM_CURSOR_CONTEXT_MENU](SDL_SYSTEM_CURSOR_CONTEXT_MENU)
- [SDL_SYSTEM_CURSOR_COPY](SDL_SYSTEM_CURSOR_COPY)
...
- [SDL_SYSTEM_CURSOR_GRAB](SDL_SYSTEM_CURSOR_GRAB)
- [SDL_SYSTEM_CURSOR_GRABBING](SDL_SYSTEM_CURSOR_GRABBING)
- [SDL_SYSTEM_CURSOR_HELP](SDL_SYSTEM_CURSOR_HELP)
...
- [SDL_SYSTEM_CURSOR_NO_DROP](SDL_SYSTEM_CURSOR_NO_DROP)
...
- [SDL_SYSTEM_CURSOR_ROW_RESIZE](SDL_SYSTEM_CURSOR_ROW_RESIZE)
...
- [SDL_SYSTEM_CURSOR_VERTICAL_TEXT](SDL_SYSTEM_CURSOR_VERTICAL_TEXT)
- [SDL_SYSTEM_CURSOR_W_RESIZE](SDL_SYSTEM_CURSOR_W_RESIZE)
- [SDL_SYSTEM_CURSOR_WAIT](SDL_SYSTEM_CURSOR_WAIT)
- [SDL_SYSTEM_CURSOR_ZOOM_IN](SDL_SYSTEM_CURSOR_ZOOM_IN)
- [SDL_SYSTEM_CURSOR_ZOOM_OUT](SDL_SYSTEM_CURSOR_ZOOM_OUT)
